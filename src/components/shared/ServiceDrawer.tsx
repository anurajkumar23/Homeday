    ...
    return (
        <Drawer.Root>
            ...
            <Drawer.Portal>
                ...
                <Drawer.Popup
                    className="fixed z-[100] bottom-0 left-0 right-0 md:left-auto md:top-0 md:right-0 w-full md:w-[480px] max-h-[92vh] md:max-h-full md:h-full bg-white dark:bg-gray-900 rounded-t-[2rem] md:rounded-none md:rounded-l-[2rem] shadow-2xl flex flex-col outline-none pointer-events-auto transition-transform duration-300 data-[ending-style]:translate-y-full md:data-[ending-style]:translate-y-0 md:data-[ending-style]:translate-x-full data-[starting-style]:translate-y-full md:data-[starting-style]:translate-y-0 md:data-[starting-style]:translate-x-full"
                >
                    {/* Handle + Close */}
                    <div className="relative w-full pt-3 pb-2 flex-shrink-0 bg-white dark:bg-gray-900 rounded-t-[2rem] z-10">
                        ...
                        <Drawer.Close aria-label="Close" className="absolute top-2 right-3 w-9 h-9 bg-gray-100 dark:bg-gray-700 hover:bg-gray-200 dark:hover:bg-gray-600 rounded-full flex items-center justify-center text-gray-600 dark:text-white transition-colors z-20">
                            <X className="w-4 h-4" />
                        </Drawer.Close>
                    </div>
